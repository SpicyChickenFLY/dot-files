...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'gitsigns.nvim', 'vim-floaterm', 'Comment.nvim', 'nvim-colorizer.lua', 'telescope.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
