...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp", "cmp-buffer" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vim-floaterm', 'gitsigns.nvim', 'todo-comments.nvim', 'Comment.nvim', 'nvim-colorizer.lua', 'telescope.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
