...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-path", "cmp-buffer", "cmp-nvim-lua", "cmp-nvim-lsp" },
  ...
  ["vim-arduino"] = {
    loaded = true,
    path = "/home/chow/.local/share/nvim/site/pack/packer/start/vim-arduino",
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'Comment.nvim', 'todo-comments.nvim', 'telescope.nvim', 'gitsigns.nvim', 'nvim-colorizer.lua', 'vim-floaterm'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
