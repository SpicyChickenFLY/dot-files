...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'Comment.nvim', 'gitsigns.nvim', 'todo-comments.nvim', 'vim-floaterm', 'nvim-colorizer.lua', 'telescope.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
