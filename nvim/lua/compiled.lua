...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-buffer", "cmp-path", "cmp_luasnip", "cmp-nvim-lua" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'telescope.nvim', 'gitsigns.nvim', 'nvim-colorizer.lua', 'Comment.nvim', 'vim-floaterm'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
