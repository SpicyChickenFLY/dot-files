...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-nvim-lsp", "cmp_luasnip", "cmp-nvim-lua", "cmp-buffer" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'nvim-colorizer.lua', 'vim-floaterm', 'Comment.nvim', 'telescope.nvim', 'gitsigns.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
