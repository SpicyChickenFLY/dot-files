...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'gitsigns.nvim', 'Comment.nvim', 'todo-comments.nvim', 'telescope.nvim', 'vim-floaterm', 'nvim-colorizer.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
