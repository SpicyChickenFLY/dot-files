...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-lua", "cmp-path", "cmp-nvim-lsp", "cmp_luasnip" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'telescope.nvim', 'nvim-colorizer.lua', 'Comment.nvim', 'gitsigns.nvim', 'vim-floaterm'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
