...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-nvim-lsp", "cmp_luasnip", "cmp-buffer", "cmp-path" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'telescope.nvim', 'Comment.nvim', 'gitsigns.nvim', 'vim-floaterm', 'nvim-colorizer.lua', 'todo-comments.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
