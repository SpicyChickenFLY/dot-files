...
_G.packer_plugins = {
  ...
  ["nvim-ts-autopairs"] = {
    loaded = true,
    path = "/home/chow/.local/share/nvim/site/pack/packer/start/nvim-ts-autopairs",
    url = "https://github.com/windwp/nvim-ts-autopairs"
  },
  ["nvim-ts-autotag"] = {
    loaded = true,
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vim-floaterm', 'nvim-colorizer.lua', 'gitsigns.nvim', 'todo-comments.nvim', 'telescope.nvim', 'Comment.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
