...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-floaterm', 'Comment.nvim', 'todo-comments.nvim', 'telescope.nvim', 'nvim-colorizer.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
