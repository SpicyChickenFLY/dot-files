...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-nvim-lua", "cmp-buffer", "cmp-path" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'nvim-colorizer.lua', 'telescope.nvim', 'Comment.nvim', 'gitsigns.nvim', 'vim-floaterm'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
