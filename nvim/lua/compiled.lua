...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-path", "cmp-nvim-lua", "cmp-buffer" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'telescope.nvim', 'gitsigns.nvim', 'nvim-colorizer.lua', 'vim-floaterm', 'Comment.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
