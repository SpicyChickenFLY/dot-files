...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'Comment.nvim', 'gitsigns.nvim', 'vim-floaterm', 'telescope.nvim', 'todo-comments.nvim', 'nvim-colorizer.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
