...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'gitsigns.nvim', 'vim-floaterm', 'todo-comments.nvim', 'telescope.nvim', 'nvim-colorizer.lua', 'Comment.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
