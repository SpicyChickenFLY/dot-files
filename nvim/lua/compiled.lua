...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'gitsigns.nvim', 'telescope.nvim', 'todo-comments.nvim', 'Comment.nvim', 'vim-floaterm', 'nvim-colorizer.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
