...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'telescope.nvim', 'todo-comments.nvim', 'vim-floaterm', 'nvim-colorizer.lua', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
