...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lua", "cmp-path", "cmp-buffer", "cmp-nvim-lsp", "cmp_luasnip" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'Comment.nvim', 'todo-comments.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim', 'vim-floaterm', 'telescope.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
