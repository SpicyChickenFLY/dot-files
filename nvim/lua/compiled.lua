...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp_luasnip", "cmp-nvim-lsp", "cmp-buffer", "cmp-path", "cmp-nvim-lua" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vim-floaterm', 'todo-comments.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim', 'Comment.nvim', 'telescope.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
