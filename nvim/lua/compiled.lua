...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'telescope.nvim', 'Comment.nvim', 'gitsigns.nvim', 'vim-floaterm', 'nvim-colorizer.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
