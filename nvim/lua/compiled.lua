...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'vim-floaterm', 'gitsigns.nvim', 'nvim-colorizer.lua', 'todo-comments.nvim', 'telescope.nvim', 'Comment.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
