...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-buffer", "cmp_luasnip", "cmp-nvim-lua", "cmp-path" },
...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'Comment.nvim', 'telescope.nvim', 'todo-comments.nvim', 'gitsigns.nvim', 'vim-floaterm', 'nvim-colorizer.lua'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
