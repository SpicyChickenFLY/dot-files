...
vim.cmd [[au BufWinEnter * ++once lua require("packer.load")({'todo-comments.nvim', 'vim-floaterm', 'telescope.nvim', 'gitsigns.nvim', 'nvim-colorizer.lua', 'Comment.nvim'}, { event = "BufWinEnter *" }, _G.packer_plugins)]]
